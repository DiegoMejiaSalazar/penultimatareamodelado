...
descriptores = numpy.array(lista_pixels)
descriptores = descriptores.reshape(descriptores.shape[0], descriptores.shape[1] * descriptores.shape[2])
plus_descriptors1 = numpy.array(get_descriptor("plusdataset/ggg.jpeg", True))
plus_descriptors_aux1 = plus_descriptors1.reshape((plus_descriptors1.shape[0], plus_descriptors1.shape[2]))
